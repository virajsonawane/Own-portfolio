      ...
      <div className="mx-auto max-w-6xl px-4 pt-4 sm:px-6">
        ...
        >
          ...
          <button
            ...
            className="group flex max-w-[12rem] items-center gap-2 truncate rounded-full px-3 py-2 text-left text-base font-semibold tracking-tight text-zinc-900 transition hover:bg-white/18 dark:text-white"
          >
